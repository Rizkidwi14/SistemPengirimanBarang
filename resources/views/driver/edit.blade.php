...
@section('container')
    <div class="col-6 bg-light px-3 py-2 shadow">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center">
            <h1 class="h2">Edit Data Driver<h1>
        </div>

        <div class="row align-items-start">
            <div class="col-md">
                <form method="POST" action="/driver/{{ $driver->slug }}" class="mb-1" enctype="multipart/form-data">
                    @method('put')
                    @csrf
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" name="nama" id="nama"
                            ...
                            value="{{ old('nama', $driver->nama) }}" autocomplete="off" required autofocus>
                        @error('nama')
                        ...
                        <input type="hidden" name="slug" id="slug" class="form-control"
                            value="{{ old('slug', $driver->slug) }}" autocomplete="off" required>
                    </div>
                    ...
                    <div class="mb-2">
                        ...
                        <input type="number" name="nik" id="nik"
                            class="form-control text-uppercase @error('nik') is-invalid @enderror"
                            value="{{ old('nik', $driver->nik) }}" required
                    ...
                    <div class="mb-2">
                        ...
                        <input type="email" name="email" id="email"
                            ...
                            value="{{ old('email', $driver->email) }}" autocomplete="off" required>
                        @error('email')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-2">
                        ...
                        <input type="number" name="no_telepon" id="no_telepon" pattern="[0-9]"
                            class="form-control text-uppercase @error('no_telepon') is-invalid @enderror"
                            value="{{ old('no_telepon', $driver->no_telepon) }}" autocomplete="off" required
                    ...
                    <button type="submit" class="btn btn-primary">Ubah Driver</button>
                </form>
            </div>
        </div>
    </div>
